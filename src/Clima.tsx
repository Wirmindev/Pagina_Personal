...
const App = () => {
    ...
    return (
        <div className='w-screen h-screen bg-[#27222c] flex items-center justify-center'>
            <div className='h-90 w-90 bg-[#6553b0] flex flex-col rounded-lg p-5'>
                <div className='flex fex-row'>
                    ...
                    <img className='w-20 flex' src={weather?.current.condition.icon}></img>
                </div>
            ...
            <div className='flex flex-row'>
                <h1 className=' flex text-white m-2'>Date: {weather?.forecast.forecastday.map(date => {return date.date})}</h1>
            </div>
